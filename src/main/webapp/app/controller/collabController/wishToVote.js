                            ...
                            <tr>
                                <td>
                                    <div> 
                                        ...
                                        <span @mouseover="userAlreadyVotedKo(wish)" @mouseleave="hideMessage()" @click="addVoteKo(wish)" style="cursor: pointer;"><img src="img/other_icon/unlike.png" width="40" height="40" style="position: absolute; left:80%; z-index:1;"></span>
                                        <br><br>
