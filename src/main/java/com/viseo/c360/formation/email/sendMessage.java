...
public class sendMessage {
    ...
    public static void generateAndSendEmail(String email, long id) throws AddressException, MessagingException {
        ...
        String emailBody = "Please follow the link below to reset your password" + "<br> <a href='http://c360-dev.viseolab.com/#/resetPassword/"+ id +"'>Reset Password</a>" + "<br><br> Regards, <br>C360 Admin";
